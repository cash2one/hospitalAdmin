...
*/
!function ($, moment) {
var DateRangePicker_id = 1;
    var DateRangePicker = function (element, options, cb) {
    	this.DateRangePicker_id = DateRangePicker_id++;
    ...
    DateRangePicker.prototype = {
        ...
        show: function (e) {
            ...
            this.container.attr("input_id",this.DateRangePicker_id);//
            this.container.show();
            this.move();
        ...
        hide: function (e) {
            ...
            $(document).off('click[input_id='+this.DateRangePicker_id+"]", this.outsideClick);//$(this.element).attr("input_id")
