                             	...
                             	<div class="panel">
                                        <div class="panel-body" style="padding-left:-15px;"> 
                                            <ul class="nav nav-tabs no-border-margin1" style="border-bottom: none!important;float:left;">
                                                <li class="current">
                                               		 <a href="#" class="remote_href" value="0" style="padding:10px 5px;">产后第一次访视</a>
                                                </li>
                                                <li class="">
                                   ...
                                   <tr>
                                    ...
                                    <tr>
                                       ...
                                       <td >会阴：
                                       	  ...
                                       	  <c:if test="${visitRecord.perinealWound==8 }">未愈合</c:if>
                                       	  <c:if test="${visitRecord.perinealWound==9 }">增生 </c:if>
                                       	  <c:if test="${visitRecord.perinealWound==10 }">未查 </c:if>
                                       </td>
                                   </tr>
                                    <tr>
                                       <td >恶露：
