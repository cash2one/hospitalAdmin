...
<body>
	...
	<!--控制类-->
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/public/public.js" charset="gbk"></script>
	...
	$(function(){
		...
		$('.tname').append('<span style="color: #919499;">'+recveNickName+'</span>');
		if(!recveImg){
