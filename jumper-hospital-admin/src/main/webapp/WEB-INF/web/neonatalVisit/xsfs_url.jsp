...
<!-- 新生儿访视共同的url -->
		...
		<ul id="myTab" class="nav nav-tabs">
	            ...
	            <li><a  href="${pageContext.request.contextPath}/PregnantEnd/lookIndex?userId=${userId}archiveId=${archiveId}&archiveBaseId=${archiveBaseId}" >分娩结局</a></li>
	            ...
	            <li><a  class="active2" href="javascript:void(0);">新生儿访视</a></li>
		</ul>
</html>