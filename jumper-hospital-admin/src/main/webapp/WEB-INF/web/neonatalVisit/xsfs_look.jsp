...
<div class="col-xs-12 col-sm-9">
		<div class="panel" >
            ...
            <div class="panel panel-default float-left" style="margin:15px 0px;width: 100%;">
             ...
             <div class="panel panel-default float-left" style=" margin:15px;width: 98%;">  
                         ...
                         <table class="gw_xx">
                         		<tbody>
                                     ...
                                     <tr>
                                        ...
                                        <td colspan="2">前囟：${vbr.bregma1 }cm X ${vbr.bregma2 } cm &nbsp;&nbsp;&nbsp;
	            ...
	            <div class="gw_btn">
		            <a href="${pageContext.request.contextPath}/neonatal/updateNeonatalVist?id=${vbr.id}&archiveId=${archiveId}&archiveBaseId=${archiveBaseId}">
    	...
    	<div id="print_div" style="display: none;">
    		 <jsp:include page="/WEB-INF/web/neonatalVisit/xsfs_print.jsp" flush="true" ></jsp:include>
    	</div>
</div>
