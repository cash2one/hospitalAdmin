...
<div class="col-xs-12 col-sm-9">
		<div class="panel" >
            ...
            <div class="panel panel-default float-left" style="margin:15px 0px;width: 100%;">
                ...
                <div class="gw_noimg" style="margin-bottom:10%">
               			 <img src="${pageContext.request.contextPath}/media/image/gw_tj.jpg" width="100%">
                </div> 
                <div class="gw_btn" style="margin-bottom:50px;">
               		 <a href="${pageContext.request.contextPath}/neonatal/addNeonatalVist?userId=${userId}&archiveId=${archiveId}&archiveBaseId=${archiveBaseId}"  
               		 	class="btn btn-success" style="margin-left:35px;"><i class="icon-plus"></i> 新增新生儿访视
               		 </a>
            	</div>    
