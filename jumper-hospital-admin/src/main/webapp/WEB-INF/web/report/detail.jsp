	...
	<div class="panel panel-default" id="panel${consumer.consumerId }">
        <div class="panel-body">
            <div class="panel-head">
                <ul>
                    <li style="width:14%;">${consumer.userName }</li>
                    <li style="width:14%;">${consumer.userAge }岁</li>
                    <li style="width:14%;">孕${consumer.preganyWeek }周</li>
                    <li style="width:14%;">${consumer.remoteType }</li>
                    <li style="width:14%;"><img value="${consumer.consumerId }" class="play" src="${pageContext.request.contextPath}/media/image/button_play_hover.png"></li>
                    <li class="timeNow" style="width:14%;">--</li>
                    <li class="valueNow" style="width:14%;">--</li>
                </ul>
            </div>
