...
<script type="text/javascript" src="${pageContext.request.contextPath}/media/js/xixiang/automaticScoringKrebs.js?${v }"></script>
			            	...
			            	<tr>
			            		<td style="width:45%">
			            			<table class="source">
			            				...
			            				<tr>
			            					...
			            					<td>
			            						...
			            						<select class="leftTableData" style="width: 83px;" name="numDec" >
												  <option value ="0" <c:if test="${fhrInfo.voFhrScore.numDec ==0}"> selected ="selected"</c:if> >无或早减 </option>
												  <option value ="1" <c:if test="${fhrInfo.voFhrScore.numDec == 1}"> selected ="selected"</c:if>  >1</option>
												  <option value="2" <c:if test="${fhrInfo.voFhrScore.numDec ==2}"> selected ="selected"</c:if> >&gt;=2</option>
												</select>
			            					</td>
			            				...
			            				<tr>
			            					<td>胎动次数</td>
			            					<td><input class="leftTableData" style="width: 83px;" type="text" name="numFetalMove" value="${fhrInfo.voFhrScore.numFetalMove}"/> </td>
			            					<td id="numFetalMoveAnalysis">${scoringAnalysis.numFetalMoveAnalysis} </td>
			            					<td id="fetalMoveScore">${fhrInfo.voFhrScore.numFetalMoveScore}</td>
			            				</tr>
			            			</table>
			            		</td>
			            		<td>
			            			<table class="result">
			            				<tr>
			            					<td id="source"" >结果:kreb's评分 </td>
			            					<td > <span id="sourceScore"  style="color: red;" >${fhrInfo.voFhrScore.totalScore}</span> 分</td>
			            				</tr>
			            				<tr>
			            					<td>NST</td>
			            					<td>
